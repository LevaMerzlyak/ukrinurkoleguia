	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">Protection of Rights and Interests of Children Born in Transnational Families</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			<div class="textWrap textWrap_txtSup">
				<p class="service__txt service__txt_sup">The article deals with practical problems of registering children’s residence and obtaining documents for the children, as well as with issues of jurisdiction determination in the matters of deprivation of parental rights.</p>
			</div>
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2013-05_01.html">Only Ukrainian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
