	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">Quo Vadis?</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			<div class="textWrap textWrap_txtSup">
				<p class="service__txt service__txt_sup">The publication is dedicated to the role of legal professionals and civil society institutions in overcoming negative aspects of lawmaking and application of law in Ukraine.</p>
			</div>
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2013-06_01.html">Only Ukrainian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
