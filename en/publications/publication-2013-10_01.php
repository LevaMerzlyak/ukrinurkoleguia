	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">Public Entrance</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			<div class="textWrap textWrap_txtSup">
				<p class="service__txt service__txt_sup">The article is dedicated to the issue of obligatory membership in the Ukrainian National Association of Attorneys.</p>
			</div>
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2013-10_01.html">Only Russian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
