	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">Commencement of Probate Proceedings in Ukraine When the Deceased Is a Foreign Citizen</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			<div class="textWrap textWrap_txtSup">
				<p class="service__txt service__txt_sup">The article touches upon the details of the administration of estate located in the Ukrainian territory in case when the deceased is a foreign national.</p>
			</div>
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2014-03_01.html">Only Ukrainian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
