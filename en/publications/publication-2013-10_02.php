...
<body class="loading">
	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">Probate Experiment</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			...
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2013-10_02.html">Only Russian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
