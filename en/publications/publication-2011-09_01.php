	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">Peculiarities of Notarization of Documents for Operation Abroad</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			<div class="textWrap textWrap_txtSup">
				<p class="service__txt service__txt_sup">The article covers peculiarities of notarization of documents in Ukraine and in foreign countries. Particular consideration is also given to the issue of apostillization of documents.</p>
			</div>
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2011-09_01.html">Only Ukrainian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
