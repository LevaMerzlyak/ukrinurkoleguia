	...
	<main class="main" id="bg1">
		...
		<div class="mainTxt">
			<div class="textWrap textWrap_head">
				<h1 class="head anim__txt">International Legal Basis of the Functioning and Development of Civil Society</h1>
			</div>				
		</div>
	</main>
	<section class="service">
		<div class="serviceTxt">
			<div class="textWrap textWrap_txtSup">
				<p class="service__txt service__txt_sup">The article deals with the role of human rights and fundamental freedoms guaranteed and protected by international law for the functioning and development of civil society.</p>
			</div>
			<div class="textWrap">
				<p class="service__txt"><a href="../../publications/publication-2013-09_01.html">Only Ukrainian version of the full text is available.</a></p>
			</div>
		</div>
	</section>
		<!-- jQuery -->
